...
<div id="product-grid">
 <div class="txt-heading"><div class="txt-heading-label">Magazin</div> <div class="txt-heading-label"> <a href="Cos.php"> Cosul meu </a></div> <div class="txt-heading-label"> <a href="index.php"> All products </a></div><div class="test"> <a href="logout.php"> <?php
...
<div class="content_wrapper">
 ...
 foreach($obj->getcat() as $cos) {
 	 ...
 	 $nume_categorie= $cos['nume_categorie'];
        echo "<li><a href='test.php?cat=$nume_categorie'>$nume_categorie</a></li>";
        echo "</tr>";
      }
